...
combinations = product(
    ...
    max_level, percentage_min_instances, node_is_leaf, obj1, obj2
)

for idx, combo in enumerate(combinations):
    gen, genwi,pop, cross_prob, mut_prob, max_lvl, perc_min, node_leaf, obj1, obj2 = combo
    cmd = [
        "python",
        ".\\main.py",
        str(gen),
    ...
    log_filename = f"idx{idx}_gen{gen}_genwi{genwi}_pop{pop}_cross{cross_prob}_mut{mut_prob}_maxlvl{max_lvl}_perc{perc_min}_leaf{node_leaf}_obj1-{obj1}_obj2-{obj2}.txt"
